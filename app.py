...
from main.blueprints.api_length_percentile_calculator_blueprint.length_percentile_calculator_api import api_length_percentile_calculator_blueprint
...
app.register_blueprint(api_length_percentile_calculator_blueprint, url_prefix='/api/length_percentile_calculator')
